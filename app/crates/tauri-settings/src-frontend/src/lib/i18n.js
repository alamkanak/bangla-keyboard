const translations = {
  en: {
    ...
    'onboarding.setup.title': 'You\u2019re almost ready',
    'onboarding.setup.desc': 'Bangla Keyboard was set up during installation. Here\u2019s how to switch between Bangla and English.',
    'onboarding.setup.checking': 'Checking input method status\u2026',
    'onboarding.setup.ready': 'Bangla Keyboard is active and ready to use!',
    'onboarding.setup.notReady': 'Bangla Keyboard needs to be enabled manually.',
    'onboarding.setup.enableButton': 'Enable Bangla Keyboard',
    'onboarding.setup.manualTitle': 'Manual setup instructions',
    'onboarding.setup.hotkeysTitle': 'How to switch between Bangla and English',
  ...
  bn: {
    ...
    'onboarding.setup.title': 'আপনি প্রায় প্রস্তুত',
    'onboarding.setup.desc': 'ইনস্টলেশনের সময় বাংলা কীবোর্ড সেটআপ করা হয়েছে। এখানে বাংলা এবং ইংরেজির মধ্যে পরিবর্তন করার পদ্ধতি দেখুন।',
    'onboarding.setup.checking': 'ইনপুট পদ্ধতির অবস্থা পরীক্ষা করা হচ্ছে\u2026',
    'onboarding.setup.ready': 'বাংলা কীবোর্ড সক্রিয় এবং ব্যবহারের জন্য প্রস্তুত!',
    'onboarding.setup.notReady': 'বাংলা কীবোর্ড ম্যানুয়ালি সক্রিয় করতে হবে।',
    'onboarding.setup.enableButton': 'বাংলা কীবোর্ড সক্রিয় করুন',
    'onboarding.setup.manualTitle': 'ম্যানুয়াল সেটআপ নির্দেশাবলী',
    'onboarding.setup.hotkeysTitle': 'বাংলা এবং ইংরেজির মধ্যে কীভাবে পরিবর্তন করবেন',
